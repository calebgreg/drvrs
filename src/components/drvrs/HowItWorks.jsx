    ...
    <div className="hiw">
      <style>{`
        ...
        .hiw-rail::before {
          ...
          background: linear-gradient(to bottom, rgba(29,78,216,0.4), rgba(29,78,216,0.06));
        }
        .hiw-step:last-child .hiw-rail::before { display: none; }
        .hiw-node {
          width: 34px; height: 34px; border-radius: 50%; flex-shrink: 0;
          border: 1px solid rgba(29,78,216,0.45); display: flex; align-items: center; justify-content: center;
        ...
        .hiw-marker {
          ...
          text-transform: uppercase; color: var(--accent); padding-top: 0.55rem; margin-bottom: 0.6rem;
        }
        .hiw-line {
          font-family: 'DM Serif Display', serif; font-size: clamp(1.5rem, 2.8vw, 2.2rem);
          line-height: 1.15; letter-spacing: -0.01em; color: var(--ink); margin-bottom: 0.75rem;
        }
